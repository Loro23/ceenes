                    ...
                    child: Column(
                      children: [
                        ...
                        FlatButton(
                            ...
                            child: Text(
                                "Click here to show licences correlated with Flutter")),
                        Padding(
                            ...
                            Expanded(
                              child: Column(
                                children: [
                                  SelectableLinkify(
                                    text:
                                        "We are using the TMDB database and API which provides all the information shown for movies by our application (e.g. poster, overview, rating). Every content belonging to a movie is provided by tmdb and not by us. "
